  ...
  <header id="header" class="d-flex flex-column justify-content-center">
    ...
    <nav id="navbar" class="navbar nav-menu">
      <ul>
        ...
        <li><a href="#about" class="nav-link scrollto"><i class="bx bx-user"></i> <span>Tentang APL</span></a></li>
        <li><a href="#resume" class="nav-link scrollto"><i class="bx bx-file-blank"></i> <span>Petugas</span></a></li>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>About LAPORKAN!</h2>
          <p>LAPORKAN! merupakan aplikasi berbasis website yang melayani anda untuk melaporkan tentang apa yang ada alami kepada pihak yang berwenang</p>
        </div>
    ...
    <section id="facts" class="facts">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Facts</h2>
          <p>Website ini telah bekerja sama dengan 100 Lembaga yang berwenang dalam mengatasi hal seperti ini </p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="3390" data-purecounter-duration="1" class="purecounter"></span>
              <p>Laporan Masuk</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Laporan Masuk <i class="val">100%</i></span>
            ...
            <div class="progress">
              <span class="skill">Laporan Keluar <i class="val">90%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">Laporan Diproses <i class="val">75%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Laporan Valid <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">Laporan Tidak Valid<i class="val">90%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div class="progress">
              <span class="skill">Laporan Tertanggapi <i class="val">55%</i></span>
              <div class="progress-bar-wrap">
              ...
              <div class="card-body">
                <div class="container">
                  <div class="card shadow">
                      <div class="card" >
                          <h5 class="card-header headertabel">Anggota Petugas</h5>
                          <div class="card-body">
                  ...
                  <div class="card-body">
                      ...
                      <form action="{{''}}" method="post">
                        ...
                        <div class="mb-3" class="position-absolute top-0 end-0">
                          <textarea class="form-control" id="tanggapan" name="tanggapan" rows="5" placeholder="Tanggapan"></textarea>
                        </div>
                        <div class="mb-3 w-50">
                          <input class="form-control" type="text" id="id_petugas" name="id_petugas" placeholder="ID Petugas">
                        </div>
                        @if (session('notif'))
