    ...
    {{-- <div id="maindiv" class="d-flex vh-100">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
          ...
          <main class="d-flex flex-nowrap">
            <h1 class="visually-hidden">Damn</h1>
          
            <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
              <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-decoration-none judul">
                <span class="fs-4">LAPORKAN!</span>
              </a>
              <hr>
              <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                  <a href="DashboardAdmin" class="nav-link hum" aria-current="page">
                    <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#home"/></svg>
                    Dashboard
                  </a>
                </li>
                <li>
                  <a href="Validasi" class="nav-link val   ">
